...
![image](/docs/assets/design-images/template-examples/placeOrderScenario.png)
...
![image](/docs/assets/design-images/template-examples/facebookUserAuthentication.png)
...
- At the beginning of the engagement, publishing an "envisionsed" version of the Sequence Diagram will provide a common visual to all engineers when working on the different parts of the solution (focusing on the data flow and request flow)
...
- VS Code Plugins:
  - [PlantUML](https://marketplace.visualstudio.com/items?itemName=jebbs.plantuml) - requires a generator from code to PlantUML syntax to generate diagrams
    - [PlantUML Synatx](https://plantuml.com/sequence-diagram)
